...
public class NavFrame extends JFrame
{
	...
	/**
	 * Initialize the frame, set the title, setup the menu bar, and display the first frame.  
	 * This frame will be the input frame.  
	 */
	public NavFrame()
	{
	...
	/** 
	 * Build a file menu.  This file menu currently only gives the option to select a new floor 
	 * plan or to exit the program.  Code developed for the menu was modelled from Sun's Java Menu 
	 * Component tutorials <a 
	 * href="http://java.sun.com/docs/books/tutorial/uiswing/components/components.html">
	 * http://java.sun.com/docs/books/tutorial/uiswing/components/components.html</a>.
	 * 
	...
	public JMenu createFileMenu()
	{
		...
		// setup the action listener for the "New" menu item
        newitem.addActionListener(returnToInputFrame());	
	    
	    // a menu seperator (to make the menu look pretty)
        ...
        // to be nice, give the user the option to exit
	...
	/**
	 * Defines a new action listener which switches the content pane to remove the drawings and to 
	 * show the floor plan input frame (to allow the user to specify a new floor plan).  
	 * 
	 * @return ActionListener provides instructions on what to do when the user clicks on the file 
	 * menu item
	 */
...
//            	validate();
	 ...
	 * 
	 * @return ActionListener provides instructions on what to do when the user clicks on the 
	 * file menu item
	 */
	public ActionListener aboutBox()
	{
        return(new ActionListener()
        {
            public void actionPerformed(ActionEvent event)
            {
            	String sMsg = "Adventure!\n\nVersion: 1.0\n\nCOPYRIGHT (C) 2005 Rob Bauer.  All " +
            			"Rights Reserved.";
