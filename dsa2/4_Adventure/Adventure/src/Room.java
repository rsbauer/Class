...
public class Room {
	...
	{
		ArrayList<RoomItem> allitems = new ArrayList<RoomItem>(characters.size() + 
				roomitems.size());
	 ...
	 * @return arraylist of characters in the room
	 */
	...
	{
		// setup the list to keep track of items found
		ArrayList<RoomItem> moveable = new ArrayList<RoomItem>(roomitems.size());			
