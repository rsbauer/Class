 ...
 * <br> <br>
 * Player object.  Used to keep track of the current room the player is in as well as the player's 
 * vitals (like health).   
 * 
 * @author Rob Bauer
...
public class Player 
{
	...
	/**
	 * Get the previous room the player was in.  Handy for when the hag steals something.
	 * 
	 * @return Room the player was previously in
	 */
	public Room getPreviousRoom()
	{
		return previousroom;
	}  // end public Room getPreviousRoom()
	...
	/**
	 * Add positive or negative values to the player's health value.  Make sure it stays between 
	 * 0 and 100.
	 * 
	...
	/**
	 * Randomly remove an item from the backpack.  Seed a random number generator and then pick a 
	 * (hopefully) random number in the range of the number of items in the backpack.
	 * 
