 ...
 * <br> <br>
 * DSPRoomSet represents an object used in the Dijkstra's Shortest Path algorithm.  While locating the shortest path,
 * the room and its "cost" to get to it must be tracked.  This object keeps track of this data.
 * 
 * @author Rob Bauer
