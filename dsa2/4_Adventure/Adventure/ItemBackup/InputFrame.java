 ...
 * <br> <br>
 * Class used to build the game input options.  The user has the option of specifying the file manually, or by 
 * selecting the file from a file dialog.  
 * <br> <br>
...
public class InputFrame extends JPanel
{
	...
	public InputFrame() 
	{
	    ...
	    // check if castle.dat exists in the current directory - if so, try loading it.  Otherwise, show a file 
	    // dialog window to prompt the user to enter the file.
	...
	/**
	 * Build the input frame using Swing components.  Get the file name to read the castle contents.  Let the user
	 * override the default file name.  When forceWindow is set to true, then present the file input pane regardless
	 * if a castle.dat exists in the working directory.
	 * 
	 */
...
//			c.gridwidth = GridBagConstraints.REMAINDER;     // end row
	...
	}  // end private void addLabelTextRows(JLabel[] labels, JTextField[] textFields, GridBagLayout gridbag, ...
