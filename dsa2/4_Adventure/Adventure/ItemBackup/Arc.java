 ...
 * <br> <br>
 * An object to represent an arc between two rooms.  This object will behave (hopefully) as an edge of a graph.  
 * 
 * @author Rob Bauer
...
public class Arc 
{
	...
	/**
	 * The label or name of the arc.  This actually will be used to keep track of the arc's direction (such as north, 
	 * south, east, west). 
	 */
