 ...
 * throughout the application.  The NavFrame class starts up by displaying floor plan input option to the user. 
 * 
 * @author Rob Bauer
...
public class NavFrame extends JFrame
{
	...
	/**
	 * A panel to contain the nav items. 
	 */
	private JFrame controlPane;						// a pane to display nav items 
	...
	public NavFrame()
	{
		...
		InputFrame inputFrame = new InputFrame();	// initialize the input frame
		controlPane = this;							// be able to reference this JFrame later on by assigning here
	...
	public JMenu createFileMenu()
	{
	    ...
	    JMenuItem newitem = new JMenuItem("New"); 			// create a menu item
